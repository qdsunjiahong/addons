    ...
    def action_search(self):
        ...
        if res1:
            for res_1 in res1:
                ...
                if product_tmpl_id not in mrp_bom_product:
                    mrp_bom_product[product_tmpl_id] = product_id_mrp
        ...
        if res3:
            for res_3 in res3:
                ...
                bom_amount[(mp_id, mb_id)] = bom_amount.get((mp_id, mb_id), 0) + product_qty * product_price_dict.get(
                    price_key, 0)
        ...
        for bom_id in bom_ids:
            ...
            product_id = mrp_bom_product.get(product_tmpl_id)
        ...
        for product_l in product_data:
            ...
            sql_into = """
            insert into qdodoo_mrp_practice_compare_theory (product_id,product_number,product_number2,product_amount,product_amount2,product_price,product_price2,amount_compare,unit_compare) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s) returning id
            """ % (
                product_l, product_number, product_number2, product_amount, product_amount2, product_price,
                product_price2,
                amount_compare, unit_compare)
            ...
            for p_l in product_list:
                ...
                unit_compare = product_price - product_price2
                sql_into2 = """
                insert into mrp_practice_compare_theory_line (compare_id,mp_id,product_id,product_number,product_number2,product_amount,product_amount2,product_price,product_price2,amount_compare,unit_compare) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) returning id
                """ % (compare_id, mp_id,
