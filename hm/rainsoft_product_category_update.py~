...
class rainsoft_product_category_update(osv.Model):
		...
		_columns={
						...
						'property_stock_journal':fields.many2one('account.journal',u'库存账簿')
			}
		...
		def btn_ok(self,cr,uid,ids,context=None):
				...
				for category in categories:
						...
						stock_journal = context.get('property_stock_journal',False)
						...
						if stock_journal:
						    res['property_stock_journal']=stock_journal
