...
This model changes the format of partner's address,makes it looks much better from chinese's view.
        ...
        "hm_product_view.xml","rainsoft_product_handler_view.xml","rainsoft_product_category_update_view.xml","hm_product_export_view.xml","hm_sale_view.xml",
        "hm_purchase_view.xml",],
		"installable":True,
