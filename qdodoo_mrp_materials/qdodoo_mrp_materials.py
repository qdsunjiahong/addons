...
class qdodoo_stock_quant_tfs(models.Model):
    ...
    def _create_account_move_line(self, cr, uid, quants, move, credit_account_id, debit_account_id, journal_id, context=None):
        ...
        for cost, qty in quant_cost_qty.items():
            ...
            period_id =production_obj.qdodoo_period.id if production_obj and production_obj.qdodoo_period else context.get('force_period', self.pool.get('account.period').find(cr, uid, move.date, context=context)[0])
